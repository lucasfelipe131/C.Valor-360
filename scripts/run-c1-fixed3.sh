...
source=source.replace('onNotice?.','onNotify?.')
...
rm -f scripts/run-c1-fixed.sh .github/workflows/run-c1-fixed.yml scripts/run-c1-fixed2.sh .github/workflows/run-c1-fixed2.yml scripts/run-c1-fixed3.sh .github/workflows/run-c1-fixed3.yml
