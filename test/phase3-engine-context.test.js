...
test('toda recomendação da ValEngine aponta ao snapshot autorizado persistido',async()=>{
  ...
  const answer=await engine.answer({tenantId:'tenant-a',ownerId:'actor-a',clientId:'client-a',client:{id:'client-a',name:'Produtor'},message:'Qual é a próxima ação?',contextRequest:{requestId:'00000000-0000-4000-8000-000000000330',objective:'next_best_action',actorRole:'consultant',scope:'own_portfolio'}})
