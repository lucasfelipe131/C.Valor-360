...
test('evidência determinística lê registros camelCase (repositório) e nomeia a entidade perguntada',()=>{
 ...
 assert.match(opportunity.claim_supported,/^Oportunidade aberta “Venda de KCl” de [^ ]+ .*está em Proposta; valor registrado R\$ 80 mil; próxima ação: Enviar proposta; prazo/)
...
test('HTTP demo: caminho DEEP/CONTEXT sem modelo responde com o registro autorizado e escritas recebem 409 orientado',async()=>{
 ...
 try{
  ...
  assert.match(opportunity.payload.advice.answer,/^Oportunidade aberta “Venda de KCl para safra 25\/26” de João Pereira está em Proposta; valor registrado R\$ 80 mil\./)
