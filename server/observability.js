...
const allowedDetailKeys=new Set(['durationMs','rowCount','status','method','path','source','eventType','mode','operation','outcome','errorCode','providerStatus','retryAfterSeconds','engineMode','attachmentCount','routeId','moduleId','contractVersion','required','contextSnapshotId','memoryRefsConsidered','memoryRefsSelected','memoryRefsExcluded','exclusionReasonCounts','confidence','selectionPolicy','behaviorProfileVersion','decisionThesisId','decisionThesisVersion','valuePlanId','valuePlanVersion','actionPlanId','actionPlanVersion','insightIds','commitmentIds','visitId','visitReportId','interactionId','voiceInteractionId','transcriptId','outcomeIds','learningCandidateIds','confirmationStatus','modulesCalled','scenarioFixture','interactionType','candidateCount','confirmedCandidateCount','rejectedCandidateCount','provider','model','attempt','sizeBytes','durationSeconds','storageProvider','intent','reasoningPath','dataPath','capability','capabilityStatus','materialityScore','engineRequired','latencyStage','ttfrMs','cacheStatus','cacheHit','sampleCount','currentDataStatus','sessionId','transport','fallbackReason','disconnectReason','costUsd','inputTokens','outputTokens','budgetRemainingUsd','deviceClass','browser','domain','unsupportedFields','reasonCodes','scopeViolationCount','incompatibleEvidenceCount','provenanceViolationCount','temporalViolationCount','questionRelevance','transportDetail'])
const staticPathSegments=new Set(['api','v1','live','ready','health','release','val','core','status','auth','session','sessions','login','logout','password','admin','metrics','portfolio-admin','users','reset-password','usage','budget','events','grains','bootstrap','profiles','intents','market','technical','attachments','progress','chat','recommendations','feedback','intelligence','insights','imports','import','google-sheet','visits','preparation','report','confirm','learning-context','outcomes','action-plans','commitments','opportunities','surveys','invitations','clients','context','overview','from-survey','integrations','manual','tecnico','voice-interactions','realtime-voice','audio','process','cancel','knowledge','source-requests'])
