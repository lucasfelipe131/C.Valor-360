...
const allowedDetailKeys=new Set(['durationMs','rowCount','status','method','path','source','eventType','mode','operation','outcome','errorCode','engineMode','attachmentCount','routeId','moduleId','contractVersion','required','contextSnapshotId','memoryRefsConsidered','memoryRefsSelected','memoryRefsExcluded','exclusionReasonCounts','confidence','selectionPolicy','behaviorProfileVersion','decisionThesisId','decisionThesisVersion','valuePlanId','valuePlanVersion','actionPlanId','actionPlanVersion','insightIds','commitmentIds','modulesCalled','scenarioFixture'])
const staticPathSegments=new Set(['api','v1','live','health','val','core','status','auth','session','login','logout','password','admin','metrics','portfolio-admin','users','reset-password','usage','events','grains','bootstrap','profiles','intents','market','technical','attachments','progress','chat','recommendations','feedback','intelligence','insights','imports','import','google-sheet','visits','preparation','action-plans','commitments','opportunities','surveys','invitations','clients','context','overview','from-survey','integrations','manual','tecnico'])
