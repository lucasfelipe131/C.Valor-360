...
export function buildFastClientResponse({facts={},presentationOverride=null,message='',organizationId='unknown',ownerId='',conversationId='',contextEpoch=0,contextDomain='',now=new Date(),latencyMs=0,executionCounts={}}={}){
 ...
 const evaluatedGrounding=evaluateResponseGrounding({question:message,answer:presentation.answer,domain:groundingDomain,evidence:auditedFactsUsed,activeProducerId:String(client.id),tenantId:String(organizationId),ownerId:clean(ownerId,180),now})
