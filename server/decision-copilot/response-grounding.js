...
const globalConceptAnchor=/\b(?:conceito|definicao|ctc|ph|roi|margem|custo por hectare|ferramenta|modulo|catalogo|manual|bula|rotulo|capacidade do solo|calculo)\b/
...
const nonNameClauseLeads=new Set(['a','ainda','biblioteca','chuva','clima','como','confianca','cotacao','ctc','custo','evite','fitoscan','informe','inteligencia','manual','margem','mercado','milho','na','nao','nenhum','nenhuma','nutriscan','o','perfil','ph','por','preco','priorize','roi','selecione','soja','sua','temperatura','trigo','use','valide'])
