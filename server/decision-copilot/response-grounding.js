...
const sourceContracts=new Map([
 ...
 // turno, derrubando a resposta; as duas janelas passam a ser a mesma.
 ['market_snapshot',sourceContract(['FACT','OBSERVATION'],{maxAgeMs:7*DAY_MS,validUntilMayExtend:false})],
...
const pureGapVocabulary=new Set([
 ...
 'aberto','aberta','abertos','abertas','pendente','pendentes',
...
function isPureInsufficiencyClaim(value='',question='',domain='GENERAL'){
 ...
 const closedPatterns=[
  ...
  /^ainda nao ha compromisso em aberto registrado(?: com referencia auditavel)?$/,
