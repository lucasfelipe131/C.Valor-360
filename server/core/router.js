...
const routeDefinitions=Object.freeze({
  prepare_visit:Object.freeze({route_id:'prepare_visit.v1',modules:['MCTX','MMI','MIC','MDI','MVV','MEX','VIS'],reason_code:'explicit_visit_preparation',human_review:'policy_dependent'}),
