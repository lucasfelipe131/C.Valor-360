...
export default function Reports({clients,visits}){
 ...
 const potential=clients.reduce((sum,c)=>sum+(c.commercial?.potentialValidated===false?0:Number(c.commercial?.potential||0)),0)
