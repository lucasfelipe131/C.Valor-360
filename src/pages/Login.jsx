...
export default function Login({onLogin}){
 ...
 return <main className="login-shell">
  <section className="login-story">
   <Logo/>
   <div className="login-copy"><span className="login-kicker">INTELIGÊNCIA COMERCIAL PARA O AGRO</span><h1>Conhecer o cliente é o começo.<br/><em>Gerar valor é o objetivo.</em></h1><p>O Cliente 360 Cvale transforma perfil, relacionamento e contexto produtivo em uma próxima ação clara para cada visita.</p></div>
  ...
  <section className="login-access">
   <form className="login-card" onSubmit={submit}>
    ...
    <button className="login-submit" type="submit">Entrar no Cliente 360 <ArrowRight size={18}/></button>
