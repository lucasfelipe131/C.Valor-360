...
export default function ValContextualPanel({open,tab='context',onTab,onClose,client=null,context=null,visits=[],opportunities=[],latestPayload=null,history=[],onOpenModule,onSelectHistory}){
 ...
 // O item governado chega com fonte, autoridade, risco e caveats. Mostrar so o titulo deixava o
 // consultor sem como conferir a afirmacao e escondia justamente o aviso que a curadoria anexou
 // ("validar aplicabilidade no contexto local", "validade temporal nao informada").
