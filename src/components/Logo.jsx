...
export default function Logo({compact=false}){
 return <div className={"brand "+(compact?'compact':'')}>
   <div className="brand-mark" aria-label="C do VALOR 360">
   ...
   {!compact && <div className="brand-word"><strong>VALOR <span>360</span></strong><small>CONHECER • PERSONALIZAR • GERAR VALOR</small></div>}
 </div>
}
