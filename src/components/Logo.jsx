...
export default function Logo({compact=false}){
 return <div className={"brand "+(compact?'compact':'')}>
   <div className="brand-mark" aria-label="C do Cliente 360 Cvale">
   ...
   {!compact && <div className="brand-word"><strong>CLIENTE <span>360</span></strong><small>C.VALE • CONHECER • GERAR VALOR</small></div>}
 </div>
}
