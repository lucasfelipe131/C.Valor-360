...
export default function ProducerBusinessOverview({client,refreshToken=0}){
 ...
 return <section className="producer-business-overview" aria-labelledby="business-overview-title">
  ...
  <div className="business-metric-grid">
   ...
   <Metric icon={WalletCards} label="Crédito disponível" value={money(business.creditAvailable)} detail={`${money(business.creditUsed)} já utilizados do limite`}/>
   ...
   <Metric icon={BarChart3} label="Ganhos / perdas" value={`${finite(business.wins)} / ${finite(business.losses)}`} detail={countLabel(business.knownOutcomes,'resultado classificado','resultados classificados')}/>
